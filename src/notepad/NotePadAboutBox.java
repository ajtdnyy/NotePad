...
public class NotePadAboutBox extends javax.swing.JDialog {

    public NotePadAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(notepad.NotePadApp.class).getContext().getResourceMap(NotePadAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(notepad.NotePadApp.class).getContext().getActionMap(NotePadAboutBox.class, this);
    ...
    private void appHomepageLabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_appHomepageLabelMouseClicked
        try {
            Runtime.getRuntime().exec("rundll32   url.dll,FileProtocolHandler   http://www.vbox.top");
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(null, ex.getMessage());
            Logger.getLogger(NotePadAboutBox.class.getName()).log(Level.SEVERE, null, ex);
        }
